...
document.getElementById("stock-symbol")?.addEventListener("blur", async () => { const symbol = document.getElementById("stock-symbol").value.trim(); if (symbol) { const price = await fetchStockPrice(symbol); if (price) document.getElementById("price").value = price; } });
...
function render() { assetList.innerHTML = ""; totalsList.innerHTML = ""; profitList.innerHTML = ""; let totals = {}, profits = {}, groupedAssets = {};
